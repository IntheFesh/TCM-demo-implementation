...
|---|---|---|---|---|
| 中药学.md | 740 | **458** | 9 / 8 / 0 / 265 | `【现代研究】` 443 次 = 443 味正条目 + 15 个「附药：」子条目（22 味） |
...
| 方剂学.md | 389 | **235** | 3 / 4 / 0 / 147 | `【组成】` 235 次 = 235 张方 |
| 000-神农本草经.txt | 379 | **378** | 0 / 0 / 0 / 1 | `<篇名>` 379 个（含 3 篇序）；跳掉的 1 块是书头 |
| 018-本草备要.txt | 488 | **486** | 1 / 0 / 0 / 1 | `<篇名>` 488 个（含 3 篇序）；跳掉的是书头和一条 26 字的「银」 |
| **合计** | 3390 | **2152** | 53 / 20 / 1 / 1164 | 修正前 4818 块 ≈ ¥26.5，现在 2152 × ¥0.0055 ≈ ¥11.8 |

保留数就是真实抽取的调用数，`scripts/run_onsite.sh` 段 5 的预估（2182 = 2152 + 每源
